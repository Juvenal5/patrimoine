...
export async function DELETE(
  ...
  try {
    ...
    // Suppression forcée : on nettoie d'abord les enregistrements liés
    // (sinon la suppression de l'utilisateur échoue avec une violation
    // de contrainte de clé étrangère sur Affectation.userId).
    if (force && affCount > 0) {
