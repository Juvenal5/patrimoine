...
export default function AuthPage({ onLoginSuccess }: AuthPageProps) {
  ...
  // Pré-remplit l'e-mail si l'utilisateur avait coché "Se souvenir de moi" lors d'une précédente visite
  useEffect(() => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Se souvenir de moi : mémorise ou oublie l'e-mail selon la case
